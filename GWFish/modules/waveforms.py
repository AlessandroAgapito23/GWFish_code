...
class TaylorF2(Waveform):  
    ...
    def calculate_frequency_domain_strain(self):
        ...
        pp = np.hstack((1. * ones,
                        ...
                        11583231236531. / 4694215680. - 640. / 3. * np.pi ** 2 - 6848. / 21. * (C + np.log(4 * v)) + (-15737765635. / 3048192. + 2255. / 12. * np.pi ** 2) * eta + 76055. / 1728. * eta ** 2 - 127825. / 1296. * eta ** 3,
...
class IMRPhenomD_PPE(Waveform):
    ...
    def calculate_frequency_domain_strain(self): 
      ...
      ###################### written continuosly in frequency ##################
        ...
        amp_MR_f3, amp_MR_prime_f3 = phenomD_amp_MR_PPE(f3_amp, self.gw_params, ff_damp, ff_RD, gamma1, gamma3)
        amp_MR_f3 = float(amp_MR_f3)
        amp_MR_prime_f3 = float(amp_MR_prime_f3)
        ...
        f_cut = (0.15 + 0.04894*chi_eff + 0.01346*chi_eff**2)/(cst.G*M/cst.c**3) 
