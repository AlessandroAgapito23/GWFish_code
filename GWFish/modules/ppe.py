...
class TaylorF2_PPE(Waveform):
    ...
    def calculate_frequency_domain_strain(self): 
        ...
        #Depending on the choice on gw_params you recover psi_tot = psi_TF2 + psi_ppe or psi_tot = psi_TF2 + psi_gIMR
...
class IMRPhenomD_PPE(Waveform):
    ...
    def calculate_frequency_domain_strain(self): 
        ...
        # Analytical form
        psi_ins_prime_a_f1 = psi_TF2_prime = 2.*np.pi*cst.c**3/(cst.G*M)*tc +\
