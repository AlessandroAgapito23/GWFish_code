...
class Derivative:
    ...
    """
    def __init__(self, waveform, parameters, detector, eps=1e-6, waveform_class=wf.Waveform):
...
class FisherMatrix:
    def __init__(self, waveform, parameters, fisher_parameters, detector, eps=1e-6, waveform_class=wf.Waveform):
